...
In Javascript, we can use a helper transpose function and pipe:
...
In Java, we iterate through each character and check if it's a letter:
...
I actually had trouble running this locally, but I'll circle back later and try again when I have more time.
