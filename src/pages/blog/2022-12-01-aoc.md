...
This is pretty clean; it uses a defaultdict to keep track of the size of each directory (key = dir name, value = size). I'm going to check back in on how `@jonathanpaulson` is doing throughout the month.
